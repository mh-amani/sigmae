...
class AutoRegWrapper(Module):
    ...
    def forward(self, input_ids=None, input_attention_mask=None, input_embeds_enc=None,
                output_ids=None,
                output_embeds_enc=None, output_embeds_dec=None, output_attention_mask=None,
        ...
        if not teacher_force_output:
            ...
            outputs = self.output_discretizer(model_outputs[self.hidden_state_key][-1], supervision=True,
