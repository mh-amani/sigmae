...
from symbolic_bottleneck.auto_reg_wrapper.auto_reg_wrapper_skip_connection import AutoRegWrapperSkipConn
import torch

class ImageInputAutoRegWrapperSkip(AutoRegWrapperSkipConn):
